...
* **🎨 Modern UI/UX:** Dark mode aesthetics, custom CSS variables, flexbox/grid layouts, and fully responsive design for seamless mobile and desktop experiences.
* **🔒 Secure & Accessible:** Implements HTML escaping to prevent XSS vulnerabilities and utilizes proper ARIA roles for screen-reader and keyboard accessibility.

## 🛠️ Technology Stack
* **HTML5:** Semantic structure.
* **CSS3:** Vanilla CSS featuring glassmorphism, transitions, and responsive grids.
...
4. **To use the AI Assistant:** Paste your Google Gemini API Key into the settings panel on the left sidebar to enable the chat functionality.

## 🤝 Contributing
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/khushbu12333/election_AI/issues).
